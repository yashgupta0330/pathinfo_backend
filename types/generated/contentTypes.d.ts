...
export interface ApiContactFormSubmissionContactFormSubmission
  ...
  info: {
    description: 'Stores submissions from the contact form';
...
export interface ApiContactformfieldContactformfield
  ...
  info: {
    ...
    pluralName: 'contactformfields';
    singularName: 'contactformfield';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::contactformfield.contactformfield'
    > &
      Schema.Attribute.Private;
    ...
    type: Schema.Attribute.Enumeration<
      ['text', 'email', 'select', 'textarea', 'checkbox', 'number', 'tel']
    > &
...
export interface ApiGlobalContactFormSubmissionGlobalContactFormSubmission
  extends Struct.CollectionTypeSchema {
  collectionName: 'global_contact_form_submissions';
  info: {
    description: 'Stores submissions from the global contact form';
    displayName: 'Global Contact Form Submission';
    pluralName: 'global-contact-form-submissions';
    singularName: 'global-contact-form-submission';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiGlobalSettingGlobalSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    globalContactForm: Schema.Attribute.Component<
...
export interface ApiHeaderContactFormHeaderContactForm
  extends Struct.SingleTypeSchema {
  collectionName: 'header_contact_form';
  info: {
    description: 'Contact form configuration for the header';
    displayName: 'Header Contact Form';
    pluralName: 'header-contact-forms';
    singularName: 'header-contact-form';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::header-contact-form.header-contact-form'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    ...
    successMessage: Schema.Attribute.Text &
      Schema.Attribute.DefaultTo<'Thank you for contacting us! We will get back to you soon.'>;
    title: Schema.Attribute.String &
      Schema.Attribute.Required &
...
export interface ApiJobApplicationJobApplication
  ...
  info: {
    description: 'Applications submitted by candidates for job positions';
...
export interface ApiJobJob extends Struct.CollectionTypeSchema {
  collectionName: 'jobs';
  info: {
    description: 'Job listings for careers page';
    displayName: 'Job';
    mainField: 'title';
    pluralName: 'jobs';
    singularName: 'job';
  ...
  attributes: {
    ...
    salaryCurrency: Schema.Attribute.Enumeration<
      ['USD', 'EUR', 'INR', 'AUD', 'JPY', 'Other']
    >;
...
export interface ApiMenuitemMenuitem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    children: Schema.Attribute.Relation<'oneToMany', 'api::menuitem.menuitem'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    label: Schema.Attribute.String & Schema.Attribute.Required;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::menuitem.menuitem'
    > &
      Schema.Attribute.Private;
    order: Schema.Attribute.Integer;
    parent: Schema.Attribute.Relation<'manyToOne', 'api::menuitem.menuitem'>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiSolutionSolution extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Contact: Schema.Attribute.Component<'contact.global-contact-form', true>;
    ...
    introLogo: Schema.Attribute.Media<'images'>;
    introText: Schema.Attribute.RichText;
    keyCustomersContent: Schema.Attribute.RichText;
    keyCustomersTitle: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    solutionsList: Schema.Attribute.Component<
      'solution.solution-list-item',
      true
    >;
    solutionsSectionContent: Schema.Attribute.RichText;
    solutionsSectionSubtext: Schema.Attribute.String;
    solutionsSectionTitle: Schema.Attribute.String;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::contactformfield.contactformfield': ApiContactformfieldContactformfield;
      'api::global-contact-form-submission.global-contact-form-submission': ApiGlobalContactFormSubmissionGlobalContactFormSubmission;
      'api::global-setting.global-setting': ApiGlobalSettingGlobalSetting;
      'api::header-contact-form.header-contact-form': ApiHeaderContactFormHeaderContactForm;
      'api::job-application.job-application': ApiJobApplicationJobApplication;
      'api::job.job': ApiJobJob;
      'api::menuitem.menuitem': ApiMenuitemMenuitem;
